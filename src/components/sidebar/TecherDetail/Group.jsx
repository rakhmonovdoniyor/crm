...
import { AvatarCon, BoxWrap, FourWrap, GroupWrap, HJ, LineBottom, LineBottom4, LineBottom5 } from './groupstyle'
        ...
        <BoxWrap>
            ...
            <FourWrap>
                <Bottomdiv><h1
                    ...
                    fontStyle: 'normal',
                    fontWeight: '500',
                    lineHeight: '24px'}}>{value.car.name}</h1> <p>Group name</p></Bottomdiv>
                ...
                <Bottomdiv><h1 
                 style={{color: '#6053B9',
                    ...
                    fontWeight: '700',
                    lineHeight: '32px'}}
                >{value.car.name}</h1> <p>Course</p></Bottomdiv>
                <Bottomdiv><h1 
                style={{color: '#6053B9',
                    ...
                    fontWeight: '500',
                    lineHeight: '24px'}}
                >{value.car.date}</h1> <p>Start date</p></Bottomdiv>
                <Bottomdiv>
